...
<html>
    ...
    <body>
        ...
        <div id="show-repuesto" class="content scaffold-show" role="main">
            ...
            <f:display bean="repuesto" />
            <g:form resource="${this.repuesto}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.repuesto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
